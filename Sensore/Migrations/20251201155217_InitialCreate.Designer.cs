...
namespace Sensore.Migrations
{
    ...
    [Migration("20251201155217_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sensore.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Sensore.Models.ClinicianPatientMap", b =>
                {
                    ...
                    b.HasKey("ClinicianUserId", "PatientUserId");

                    b.HasIndex("PatientUserId");

                    b.ToTable("ClinicianPatientMaps");
                });
            ...
            modelBuilder.Entity("Sensore.Models.PatientProfile", b =>
                {
                    ...
                    b.Property<int>("ContactThreshold")
                        .HasColumnType("int");

                    b.Property<int>("HighPressureThreshold")
                        .HasColumnType("int");

                    b.Property<int>("MinAlertArea")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sensore.Models.PressureFrame", b =>
                {
                    ...
                    b.Property<bool>("IsAlertFlagged")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Sensore.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Sensore.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sensore.Models.Comment", b =>
                {
                    b.HasOne("Sensore.Models.ApplicationUser", "AuthorUser")
            ...
            modelBuilder.Entity("Sensore.Models.PatientProfile", b =>
                {
                    b.HasOne("Sensore.Models.ApplicationUser", "PatientUser")
                        ...
                        .HasForeignKey("Sensore.Models.PatientProfile", "PatientUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
